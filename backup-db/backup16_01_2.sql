...
CREATE TABLE IF NOT EXISTS `angajati` (
  ...
  `Lucreaza_Pentru` bigint unsigned DEFAULT NULL,
  `ID_Functie` bigint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID_Angajat`),
  KEY `angajati_id_functie_foreign` (`ID_Functie`),
  CONSTRAINT `angajati_id_functie_foreign` FOREIGN KEY (`ID_Functie`) REFERENCES `functii` (`ID_Functie`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


INSERT INTO `angajati` (`ID_Angajat`, `Nume`, `Email`, `Telefon`, `Data_Angajare`, `Lucreaza_Pentru`, `ID_Functie`) VALUES
	(1, 'Stancu Ion', 'stancu_ion@yahoo.com', '0753702848', '2020-08-11', 6, 1),
	(2, 'Copolovici Lucian', 'lucy99@yahoo.com', '0715849365', '2020-12-04', 6, 2),
	(3, 'Munteanu Florentina-Daniela', 'flory_mnt@gmail.com', '0764902064', '2021-03-18', 11, 4),
	(4, 'Bujoreanu Gheorghe', 'gheorghebujy@yahoo.com', '0764937555', '2020-11-17', 6, 2),
	(5, 'Onu Mihaela', 'onu_miky@hotmail.com', '0785293756', '2021-02-12', 11, 4),
	(6, 'Parvulescu Vasile', 'vasilevasip2008@yahoo.com', '0738265078', '2020-01-14', 0, 3),
	(7, 'Sirbu Andrei', 'andyysirbu@gmail.com', '0750483755', '2021-09-30', 6, 2),
	(8, 'Cristofor Sergiu', 'krystofor_sergiu95@hotmail.com', '0726946276', '2021-06-15', 6, 2),
	(9, 'Iovan Stefan', 'stefaniovan@gmail.com', '0776497584', '2020-10-24', 6, 1),
	(10, 'Radu Andrei', 'andrei_raduuu@gmail.com', '0784365875', '2021-11-08', 11, 4),
	(11, 'Lica Nicolae', 'nicolae_nica2018@yahoo.com', '0757395040', '2020-09-13', 0, 5),
	(12, 'Alexandru Adriana', 'ady_adytza97@outlook.com', '0747397058', '2020-03-12', 19, 13),
	(13, 'Mesaros Claudiu-Marius', 'mes_claudiu@yahoo.com', '0765384861', '2022-01-10', 0, 11),
	(14, 'Lungu Magdalena', 'magda_lungu@gmail.com', '0737017319', '2020-07-11', 19, 6),
	(15, 'Stanciu Silviu', 'stanciusilvy@yahoo.com', '0757210324', '2021-11-30', 0, 11),
	(16, 'Patroi Alexandru', 'alex_alexandru88@outlook.com', '0760375894', '2022-01-08', 0, 10),
	(17, 'Bratescu Tatiana', 'tatianabrate2015@hotmail.com', '0758302171', '2020-09-20', 19, 12),
	(18, 'Lazaroiu Gheorghe', 'gheogheorghe@yahoo.com', '0743752018', '2020-12-30', 0, 11),
	(19, 'Ionescu Mihnea', 'mihnea_ionescu92@gmail.com', '0730814353', '2020-02-12', 0, 9),
	(20, 'Pamfil Virgil', 'virgyl86_2009@yahoo.com', '0785738750', '2021-12-05', 6, 2),
	(21, 'Dobrea Razvan-Catalin', 'catarazvyyy@outlook.com', '0764839203', '2021-03-15', 0, 10),
	(22, 'Ciuca Raluca-Catrinel', 'raluk_ciuca@yahoo.ro', '0765839405', '2021-07-29', 12, 5),
	(23, 'Ionita Paul', 'paulionita73@gmail.com', '0742512562', '2021-05-10', 0, 11),
	(24, 'Alexandru Dragos', 'dragosel_alex@gmail.com', '0758382404', '2021-10-30', 0, 10),
	(25, 'Grosu Matei-Alexandru', 'mateialex_gr78@hotmail.com', '0786575102', '2020-01-12', 19, 8),
	(26, 'Tugui Vasilica', 'vasilicavasy2018@yahoo.com', '0723424852', '2021-05-18', 12, 4),
	(27, 'Beldiman Dumitru', 'dumitrubeld1969@yahoo.com', '0747582951', '2020-02-20', 19, 7);

CREATE TABLE IF NOT EXISTS `clienti` (
  `ID_Client` bigint unsigned NOT NULL AUTO_INCREMENT,
  `Nume` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Adresa_Default` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `functii` (
  `ID_Functie` bigint unsigned NOT NULL AUTO_INCREMENT,
  `Nume` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `Departament` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `Salariu` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID_Functie`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


INSERT INTO `functii` (`ID_Functie`, `Nume`, `Departament`, `Salariu`) VALUES
	(1, 'Mester Specialist', 'Atelier', 2500),
	(2, 'Mester', 'Atelier', 2150),
	(3, 'Mester Sef', 'Atelier', 3500),
	(4, 'Agent Vanzari', 'Vanzari', 2800),
	(5, 'Specialist Vanzari', 'Vanzari', 3500),
	(6, 'Manager resurse umane', 'Administrativ', 5500),
	(7, 'Manager livrari', 'Administrativ', 5200),
	(8, 'Manager logistica', 'Administrativ', 4100),
	(9, 'Manager general', 'Administrativ', 9500),
	(10, 'Agent depozit', 'Logistica', 2200),
	(11, 'Sofer', 'Transport', 2120),
	(12, 'Contabil', 'Administrativ', 3300),
	(13, 'Manager vanzari', 'Administrativ', 6000);
...
CREATE TABLE IF NOT EXISTS `produse` (
  ...
  `Pret_Redus` double unsigned DEFAULT NULL,
  `Categorie` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Data_Adaugare` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Data_Modificare` timestamp NULL DEFAULT NULL,
